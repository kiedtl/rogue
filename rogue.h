...
extern struct Coord oldpos;				/* Position before last look() call */
extern struct Coord delta;				/* Change indicated to get_dir() */

extern struct Coord ch_ret;
